...
@NamedQueries({
		@NamedQuery(name = "GiudizioNew.getGiudizi", query = "from GiudizioNew where mensa_id = ?1 and piatto_id = ?2"),
		@NamedQuery(name = "GiudizioNew.getUserGiudizio", query = "from GiudizioNew where mensa_id = ?1 and piatto_id = ?2 and user_id = ?3") })
